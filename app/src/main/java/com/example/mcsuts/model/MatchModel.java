...
public class MatchModel {
    ...
    public int getImgTempat() {        return imgTempat;
    }
    ...
    public MatchModel(String judul, String textLeft, String textRight, String tanggal, int imgLeft, int imgRight, String tempat, int imgTempat, String capacity) {
        this.judul = judul;
        this.textLeft = textLeft;
        this.textRight = textRight;
        this.tanggal = tanggal;
